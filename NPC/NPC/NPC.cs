...
namespace _01_Works.CM._01_Scripts.NPC.NPC
{
    public abstract class Npc : PoolableMono
    {
        ...
        private static readonly INpcRoleFactory DefaultRoleFactory = new NpcRoleFactory(new NpcActionFactory());
        ...
        public INpcAction CurrentAction { get; private set; }
        ...
        protected void AssignRole(NpcRoleType roleType)
        {
            Role = DefaultRoleFactory.CreateRole(roleType);
        }
        ...
        public bool TryAcquireNextAction()
        {
            ...
            if (Role.TryGetNextAction(this, out INpcAction nextAction) == false || nextAction == null)
            {
                return false;
            }
